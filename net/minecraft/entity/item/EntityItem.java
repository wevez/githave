...
public class EntityItem extends Entity
{
    ...
    public EntityItem(World worldIn, double x, double y, double z)
    {
        super(worldIn);
        this.health = 5;
        this.hoverStart = (float)(1 * Math.PI * 2.0D);
        this.setSize(0.25F, 0.25F);
        this.setPosition(x, y, z);
        this.rotationYaw = (float)(1 * 360.0D);
        this.motionX = (double)((float)(1 * 0.20000000298023224D - 0.10000000149011612D));
        this.motionY = 0.20000000298023224D;
        this.motionZ = (double)((float)(1 * 0.20000000298023224D - 0.10000000149011612D));
    }
