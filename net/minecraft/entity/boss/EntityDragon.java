...
public class EntityDragon extends EntityLiving implements IBossDisplayData, IEntityMultiPart, IMob
{
    ...
    public void onLivingUpdate()
    {
        ...
        {
            float f = (float) Math.cos(this.animTime * (float)Math.PI * 2.0F);
            float f1 = (float) Math.cos(this.prevAnimTime * (float)Math.PI * 2.0F);
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    this.rotationYaw = MathHelper.wrapAngleTo180_float(this.rotationYaw);
                    double d4 = 180.0D - Math.atan2(d11, d13) * 180.0D / Math.PI;
                    ...
                    double d15 = (double)(-(float) Math.cos(this.rotationYaw * (float)Math.PI / 180.0F));
                    Vec3 vec31 = (new Vec3((double)(float) Math.sin(this.rotationYaw * (float)Math.PI / 180.0F), this.motionY, d15)).normalize();
                ...
                float f2 = (float) Math.cos(f12);
                float f15 = -(float) Math.sin(f12);
                float f3 = this.rotationYaw * (float)Math.PI / 180.0F;
                float f16 = (float) Math.sin(f3);
                ...
                float f18 = (float) Math.sin(this.rotationYaw * (float)Math.PI / 180.0F - this.randomYawVelocity * 0.01F);
                float f19 = (float) Math.cos(this.rotationYaw * (float)Math.PI / 180.0F - this.randomYawVelocity * 0.01F);
                ...
                for (int j = 0; j < 3; ++j)
                {
                    ...
                    float f21 = (float) Math.sin(f20);
                    float f22 = (float) Math.cos(f20);
                    float f23 = 1.5F;
