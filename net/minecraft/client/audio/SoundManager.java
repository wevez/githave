...
public class SoundManager
{
    ...
    public void setListener(EntityPlayer player, float p_148615_2_)
    {
        if (this.loaded && player != null)
        {
            ...
            float f2 = (float) Math.cos((f1 + 90.0F) * 0.017453292F);
            float f3 = (float) Math.sin((f1 + 90.0F) * 0.017453292F);
            float f4 = (float) Math.cos(-f * 0.017453292F);
            float f5 = (float) Math.sin(-f * 0.017453292F);
            float f6 = (float) Math.cos((-f + 90.0F) * 0.017453292F);
            float f7 = (float) Math.sin((-f + 90.0F) * 0.017453292F);
            float f8 = f2 * f4;
            float f9 = f3 * f4;
            float f10 = f2 * f6;
            float f11 = f3 * f6;
