...
public class EffectRenderer
{
    ...
    public void renderLitParticles(Entity entityIn, float partialTick)
    {
        ...
        float f1 = (float) Math.cos(entityIn.rotationYaw * 0.017453292F);
        float f2 = (float) Math.sin(entityIn.rotationYaw * 0.017453292F);
        float f3 = -f2 * (float) Math.sin(entityIn.rotationPitch * 0.017453292F);
        float f4 = f1 * (float) Math.sin(entityIn.rotationPitch * 0.017453292F);
        float f5 = (float) Math.cos(entityIn.rotationPitch * 0.017453292F);
