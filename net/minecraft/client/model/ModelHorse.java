...
public class ModelHorse extends ModelBase
{
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
    {
        ...
        if (p_78086_3_ > 0.2F)
        {
            f4 += (float) Math.cos(p_78086_2_ * 0.4F) * 0.15F * p_78086_3_;
        }
        ...
        float f10 = (float) Math.cos(p_78086_2_ * 0.6662F + (float)Math.PI);
        ...
        float f16 = (float) Math.cos(f9 * 0.6F + (float)Math.PI);
        ...
        this.backLeftShin.rotationPointY = this.backLeftLeg.rotationPointY + (float) Math.sin(((float)Math.PI / 2F) + f15 + f7 * -f10 * 0.5F * p_78086_3_) * 7.0F;
        this.backLeftShin.rotationPointZ = this.backLeftLeg.rotationPointZ + (float) Math.cos(((float)Math.PI * 3F / 2F) + f15 + f7 * -f10 * 0.5F * p_78086_3_) * 7.0F;
        this.backRightShin.rotationPointY = this.backRightLeg.rotationPointY + (float) Math.sin(((float)Math.PI / 2F) + f15 + f7 * f10 * 0.5F * p_78086_3_) * 7.0F;
        this.backRightShin.rotationPointZ = this.backRightLeg.rotationPointZ + (float) Math.cos(((float)Math.PI * 3F / 2F) + f15 + f7 * f10 * 0.5F * p_78086_3_) * 7.0F;
        float f17 = (-1.0471976F + f16) * f6 + f11 * f7;
        float f18 = (-1.0471976F + -f16) * f6 + -f11 * f7;
        this.frontLeftShin.rotationPointY = this.frontLeftLeg.rotationPointY + (float) Math.sin(((float)Math.PI / 2F) + f17) * 7.0F;
        this.frontLeftShin.rotationPointZ = this.frontLeftLeg.rotationPointZ + (float) Math.cos(((float)Math.PI * 3F / 2F) + f17) * 7.0F;
        this.frontRightShin.rotationPointY = this.frontRightLeg.rotationPointY + (float) Math.sin(((float)Math.PI / 2F) + f18) * 7.0F;
        this.frontRightShin.rotationPointZ = this.frontRightLeg.rotationPointZ + (float) Math.cos(((float)Math.PI * 3F / 2F) + f18) * 7.0F;
        ...
        if (flag)
        {
            this.tailBase.rotateAngleY = (float) Math.cos(f9 * 0.7F);
            f12 = 0.0F;
        }
        else
        {
