...
public class ModelOcelot extends ModelBase
{
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        if (this.field_78163_i != 3)
        {
            ...
            {
                this.ocelotBackLeftLeg.rotateAngleX = (float) Math.cos(limbSwing * 0.6662F) * 1.0F * limbSwingAmount;
                this.ocelotBackRightLeg.rotateAngleX = (float) Math.cos(limbSwing * 0.6662F + 0.3F) * 1.0F * limbSwingAmount;
                this.ocelotFrontLeftLeg.rotateAngleX = (float) Math.cos(limbSwing * 0.6662F + (float)Math.PI + 0.3F) * 1.0F * limbSwingAmount;
                this.ocelotFrontRightLeg.rotateAngleX = (float) Math.cos(limbSwing * 0.6662F + (float)Math.PI) * 1.0F * limbSwingAmount;
                this.ocelotTail2.rotateAngleX = 1.7278761F + ((float)Math.PI / 10F) * (float) Math.cos(limbSwing) * limbSwingAmount;
            }
            else
            {
                this.ocelotBackLeftLeg.rotateAngleX = (float) Math.cos(limbSwing * 0.6662F) * 1.0F * limbSwingAmount;
                this.ocelotBackRightLeg.rotateAngleX = (float) Math.cos(limbSwing * 0.6662F + (float)Math.PI) * 1.0F * limbSwingAmount;
                this.ocelotFrontLeftLeg.rotateAngleX = (float) Math.cos(limbSwing * 0.6662F + (float)Math.PI) * 1.0F * limbSwingAmount;
                this.ocelotFrontRightLeg.rotateAngleX = (float) Math.cos(limbSwing * 0.6662F) * 1.0F * limbSwingAmount;

                if (this.field_78163_i == 1)
                {
                    this.ocelotTail2.rotateAngleX = 1.7278761F + ((float)Math.PI / 4F) * (float) Math.cos(limbSwing) * limbSwingAmount;
                }
                else
                {
                    this.ocelotTail2.rotateAngleX = 1.7278761F + 0.47123894F * (float) Math.cos(limbSwing) * limbSwingAmount;
                }
            }
        }
    }
