            ...
            if (this.interactionDelay == 0)
            {
                ...
                for (int i = 0; i < inventorybasic.getSizeInventory(); ++i)
                {
                    ...
                    if (itemstack1 != null)
                    {
                        ...
                        entityitem.motionX = (double)(-(float) Math.sin(f1 / 180.0F * (float)Math.PI) * (float) Math.cos(f2 / 180.0F * (float)Math.PI) * f);
                        entityitem.motionZ = (double)((float) Math.cos(f1 / 180.0F * (float)Math.PI) * (float) Math.cos(f2 / 180.0F * (float)Math.PI) * f);
                        entityitem.motionY = (double)(-(float) Math.sin(f2 / 180.0F * (float)Math.PI) * f + 0.1F);
