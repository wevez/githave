...
public class EntityXPOrb extends Entity
{
    ...
    public EntityXPOrb(World worldIn, double x, double y, double z, int expValue)
    {
        ...
        this.rotationYaw = (float)(1 * 360.0D);
        this.motionX = (double)((float)(1 * 0.20000000298023224D - 0.10000000149011612D) * 2.0F);
        this.motionY = (double)((float)(1 * 0.2D) * 2.0F);
        this.motionZ = (double)((float)(1 * 0.20000000298023224D - 0.10000000149011612D) * 2.0F);
