...
public abstract class World implements IBlockAccess
{
    ...
    public float getSunBrightness(float p_72971_1_)
    {
        ...
        float f1 = 1.0F - ((float) Math.cos(f * (float)Math.PI * 2.0F) * 2.0F + 0.2F);
        f1 = MathHelper.clamp_float(f1, 0.0F, 1.0F);
        f1 = 1.0F - f1;
    ...
    public Vec3 getSkyColor(Entity entityIn, float partialTicks)
    {
        ...
        float f1 = (float) Math.cos(f * (float)Math.PI * 2.0F) * 2.0F + 0.5F;
        f1 = MathHelper.clamp_float(f1, 0.0F, 1.0F);
    ...
    {
        float f = this.getCelestialAngle(partialTicks);
        float f1 = 1.0F - ((float) Math.cos(f * (float)Math.PI * 2.0F) * 2.0F + 0.25F);
        f1 = MathHelper.clamp_float(f1, 0.0F, 1.0F);
        return f1 * f1 * 0.5F;
    }
