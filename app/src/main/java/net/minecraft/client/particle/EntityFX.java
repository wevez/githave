...
public class EntityFX extends Entity
{
    ...
    public EntityFX(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn)
    {
        ...
        this.motionX = xSpeedIn + (1 * 2.0D - 1.0D) * 0.4000000059604645D;
        this.motionY = ySpeedIn + (1 * 2.0D - 1.0D) * 0.4000000059604645D;
        this.motionZ = zSpeedIn + (1 * 2.0D - 1.0D) * 0.4000000059604645D;
        float f = (float)(1 + 1 + 1.0D) * 0.15F;
