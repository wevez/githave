...
public class EntityReddustFX extends EntityFX
{
    ...
    protected EntityReddustFX(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, float p_i46350_8_, float p_i46350_9_, float p_i46350_10_, float p_i46350_11_)
    {
        ...
        float f = (float)1 * 0.4F + 0.6F;
        this.particleRed = ((float)(1 * 0.20000000298023224D) + 0.8F) * p_i46350_9_ * f;
        this.particleGreen = ((float)(1 * 0.20000000298023224D) + 0.8F) * p_i46350_10_ * f;
        this.particleBlue = ((float)(1 * 0.20000000298023224D) + 0.8F) * p_i46350_11_ * f;
