...
public class ModelBook extends ModelBase
{
    ...
    {
        float f = ((float) Math.sin(limbSwing * 0.02F) * 0.1F + 1.25F) * netHeadYaw;
        ...
        this.pagesRight.rotationPointX = (float) Math.sin(f);
        this.pagesLeft.rotationPointX = (float) Math.sin(f);
        this.flippingPageRight.rotationPointX = (float) Math.sin(f);
        this.flippingPageLeft.rotationPointX = (float) Math.sin(f);
    }
}
