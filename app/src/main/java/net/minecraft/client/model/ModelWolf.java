...
public class ModelWolf extends ModelBase
{
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float p_78086_2_, float p_78086_3_, float partialTickTime)
    {
        ...
        {
            this.wolfTail.rotateAngleY = (float) Math.cos(p_78086_2_ * 0.6662F) * 1.4F * p_78086_3_;
        }
        ...
        else
        {
            ...
            this.wolfLeg3.setRotationPoint(-2.5F, 16.0F, -4.0F);
            this.wolfLeg4.setRotationPoint(0.5F, 16.0F, -4.0F);
            this.wolfLeg1.rotateAngleX = (float) Math.cos(p_78086_2_ * 0.6662F) * 1.4F * p_78086_3_;
            this.wolfLeg2.rotateAngleX = (float) Math.cos(p_78086_2_ * 0.6662F + (float)Math.PI) * 1.4F * p_78086_3_;
            this.wolfLeg3.rotateAngleX = (float) Math.cos(p_78086_2_ * 0.6662F + (float)Math.PI) * 1.4F * p_78086_3_;
            this.wolfLeg4.rotateAngleX = (float) Math.cos(p_78086_2_ * 0.6662F) * 1.4F * p_78086_3_;
        }
