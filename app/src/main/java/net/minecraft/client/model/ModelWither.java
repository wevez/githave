...
public class ModelWither extends ModelBase
{
    ...
    {
        float f = (float) Math.cos(ageInTicks * 0.1F);
        this.field_82905_a[1].rotateAngleX = (0.065F + 0.05F * f) * (float)Math.PI;
        this.field_82905_a[2].setRotationPoint(-2.0F, 6.9F + (float) Math.cos(this.field_82905_a[1].rotateAngleX) * 10.0F, -0.5F + (float) Math.sin(this.field_82905_a[1].rotateAngleX) * 10.0F);
