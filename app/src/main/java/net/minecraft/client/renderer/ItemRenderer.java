...
public class ItemRenderer
{
    ...
    private float getMapAngleFromPitch(float pitch)
    {
        ...
        f = -(float) Math.cos(f * (float)Math.PI) * 0.5F + 0.5F;
        return f;
    }
    ...
    {
        float f = -0.4F * (float) Math.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
        float f1 = 0.2F * (float) Math.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI * 2.0F);
        float f2 = -0.2F * (float) Math.sin(swingProgress * (float)Math.PI);
        ...
        float f4 = (float) Math.sin(swingProgress * swingProgress * (float)Math.PI);
        float f5 = (float) Math.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
    ...
    {
        float f = -0.3F * (float) Math.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
        float f1 = 0.4F * (float) Math.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI * 2.0F);
        float f2 = -0.4F * (float) Math.sin(swingProgress * (float)Math.PI);
        GlStateManager.translate(f, f1, f2);
        GlStateManager.translate(0.64000005F, -0.6F, -0.71999997F);
        GlStateManager.translate(0.0F, equipProgress * -0.6F, 0.0F);
        GlStateManager.rotate(45.0F, 0.0F, 1.0F, 0.0F);
        float f3 = (float) Math.sin(swingProgress * swingProgress * (float)Math.PI);
        float f4 = (float) Math.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
    ...
    private void performDrinking(AbstractClientPlayer clientPlayer, float partialTicks)
    {
        ...
        float f2 = Math.abs((float) Math.cos(f / 4.0F * (float)Math.PI) * 0.1F);
    ...
    private void transformFirstPersonItem(float equipProgress, float swingProgress)
    {
        ...
        float f1 = (float) Math.sin(MathHelper.sqrt_float(swingProgress) * (float)Math.PI);
    ...
    private void doBowTransformations(float partialTicks, AbstractClientPlayer clientPlayer)
    {
        ...
        if (f1 > 0.1F)
        {
            float f2 = (float) Math.sin((f - 0.1F) * 1.3F);
            float f3 = f1 - 0.1F;
            float f4 = f2 * f3;
