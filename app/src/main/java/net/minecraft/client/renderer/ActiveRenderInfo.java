...
public class ActiveRenderInfo
{
    ...
    public static void updateRenderInfo(EntityPlayer entityplayerIn, boolean p_74583_1_)
    {
        ...
        rotationX = (float) Math.cos(f3 * (float)Math.PI / 180.0F) * (float)(1 - i * 2);
        rotationZ = (float) Math.sin(f3 * (float)Math.PI / 180.0F) * (float)(1 - i * 2);
        rotationYZ = -rotationZ * (float) Math.sin(f2 * (float)Math.PI / 180.0F) * (float)(1 - i * 2);
        rotationXY = rotationX * (float) Math.sin(f2 * (float)Math.PI / 180.0F) * (float)(1 - i * 2);
        rotationXZ = (float) Math.cos(f2 * (float)Math.PI / 180.0F);
    }
