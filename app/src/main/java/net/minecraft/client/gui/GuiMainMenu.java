...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private void drawPanorama(int p_73970_1_, int p_73970_2_, float p_73970_3_)
    {
        ...
        for (int k = 0; k < j; ++k)
        {
            ...
            GlStateManager.rotate((float) Math.sin(((float)this.panoramaTimer + p_73970_3_) / 400.0F) * 25.0F + 20.0F, 1.0F, 0.0F, 0.0F);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        float f = 1.8F - Math.abs((float) Math.sin((float)(Minecraft.getSystemTime() % 1000L) / 1000.0F * (float)Math.PI * 2.0F) * 0.1F);
