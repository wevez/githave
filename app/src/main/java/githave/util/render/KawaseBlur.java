...
public class KawaseBlur implements MCHook {
    ...
    private static void initFramebuffers(float iterations) {
        ...
        framebufferList.add(framebuffer = Render2DUtil.createFrameBuffer(null));
    ...
    public static void renderBlur(int stencilFrameBufferTexture, int iterations, int offset) {
        ...
        Render2DUtil.bindTexture(stencilFrameBufferTexture);
        GL13.glActiveTexture(GL13.GL_TEXTURE0);
        Render2DUtil.bindTexture(framebufferList.get(1).framebufferTexture);
        ShaderUtil.drawQuads();
        kawaseUp.unload();


        mc.getFramebuffer().bindFramebuffer(true);
        Render2DUtil.bindTexture(framebufferList.get(0).framebufferTexture);
    ...
    private static void renderFBO(Framebuffer framebuffer, int framebufferTexture, ShaderUtil shader, float offset) {
        ...
        shader.init();
        Render2DUtil.bindTexture(framebufferTexture);
