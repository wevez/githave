...
public class ShaderUtil implements MCHook {
    ...
    public ShaderUtil(String fragmentShaderLoc, String vertexShaderLoc) {
        ...
        switch (fragmentShaderLoc) {
            ...
            case "roundedRectGradient":
                ...
                break;
            default:
                fragmentShaderID = createShader(new ByteArrayInputStream(vertex.getBytes()), GL_FRAGMENT_SHADER);
                break;
        }
    ...
    public ShaderUtil(String fragmentShadersrc, boolean notUsed) {
        ...
        try {
            vertexShaderID = createShader(mc.getResourceManager().getResource(new ResourceLocation("assets/minecraft/client/shader/vertex.vsh")).getInputStream(), GL_VERTEX_SHADER);
        } catch (IOException e) {
    ...
    public ShaderUtil(String fragmentShaderLoc) {
        this(fragmentShaderLoc, "assets/minecraft/client/shader/vertex.vsh");
    }
    ...
    private String vertex = "#version 120\n" +
            "\n" +
            "void main() {\n" +
